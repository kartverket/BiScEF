...
hdf5File.attrs["SLMHeight"] = float(Hipp)
...
unixEpoch = datetime.datetime(1970,1,1)
...
Longitude.attrs["Description"] = "Longitude of the Ionospheric Pierce Point (IPP), in degrees East."
Latitude.attrs["Description"] = "Latitude of the Ionospheric Pierce Point (IPP), in degrees North."
